...
// @namespace    https://github.com/Ma15fo43/Improved-Scratch-Experience/new/master
// @version      1.1
...
(function () {
    ...
    function followingH2Checker() {
        while (document.getElementsByTagName("h4")[y].innerText != "Following") {
            y++;
    ...
    function followersH2Checker() {
        while (document.getElementsByTagName("h4")[i].innerText != "Followers") {
            i++;
